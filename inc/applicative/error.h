...
typedef enum {
	...
	ERROR_BASE_TIM21 = (ERROR_BASE_SPI1 + SPI_ERROR_BASE_LAST),
	...
	ERROR_BASE_S2LP = (ERROR_BASE_NEOM8N + NEOM8N_ERROR_BASE_LAST),
	ERROR_BASE_SHT3X = (ERROR_BASE_NEOM8N + NEOM8N_ERROR_BASE_LAST),
	// Libraries.
	ERROR_BASE_SIGFOX = (ERROR_BASE_SHT3X + SHT3X_ERROR_BASE_LAST),
	// Last index.
